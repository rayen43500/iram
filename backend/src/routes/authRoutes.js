...
const { requestEmailOtp, requestEmailOtpPublic, verifyEmailOtp, verifyEmailOtpPublic, resetPasswordPublic, changePassword, listLoginHistory } = require('../controllers/securityController');
